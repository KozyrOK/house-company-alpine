...
@section('content')
    <section class="content-item-wrapper">
        ...
        <div class="top-crud-wrapper">
            <div class="button-wrapper"><x-link text="← Back to detail" href="{{ route('admin.users.show', $user) }}" class="button-list"/></div>
            <div><img class="company-image" src="{{ $user->image_path ?: asset('images/default-image-company.jpg') }}" alt="user image"></div>
        ...
        <form method="POST" action="{{ route('admin.users.update', $user) }}">
            ...
            <div class="bottom-crud-wrapper">
                ...
                <div class="flex justify-end"><x-link text="Cancel" href="{{ route('admin.users.show', $user) }}" class="button-delete"/></div>
            </div>
        </form>
    </section>
@endsection
